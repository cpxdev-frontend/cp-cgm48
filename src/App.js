          ...
          <DialogContent>
            ...
            {item.timerange[0] > 0 && item.timerange[1] == 0 && (
             ...
             <p className='mt-1 mb-3'>
              ...
              <a onClick={() => item.link.include('https://') ? window.open(item.link, '_blank') : History.push(item.link)} className='mt-1'>
                  Reference Link
              </a>
            <br />
              {
      ...
      <DialogTitle id="alert-dialog-title">Advertisement - {newspop[0].title}</DialogTitle>
        <DialogContent>
          <CardContent>
            ...
            <a onClick={() => newspop[0].link.include('https://') ? window.open(newspop[0].link, '_blank') : History.push(newspop[0].link)} className='mt-1'>
                Reference Link
            </a>
            <br />
            {
