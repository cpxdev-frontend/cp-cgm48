      ...
      fetch(
        ...
        .then((data) => {
          if (data.response == "Not found this member in record.") {
            ...
            fetch(
              fet +
                "/cgm48/getadsupdateformem?n=" +
                resp.name.toLowerCase() +
                "&g=" +
                resp.gen +
                "&t=" +
                resp.team.toLowerCase(),
              {
                method: "post",
              }
            )
              ...
              .then((dataads) => {
                const obj = dataads.filter(
                  (x) =>
                    ...
                    x.memtag.indexOf(
                      "team_" + data.response.team.toLowerCase()
                    ) > -1
                );
                setNewspop(obj);
    ...
    <>
        ...
        <Alert
          ...
          {live != null && (
            <CardHeader
              title={
                <h6>
                  {live.member} CGM48 is LIVE now on IAM48 Application. Let's
                  watch it!
                </h6>
              }
              subheader={live.desc}
      ...
      <div className="pt-5 pb-2" data-aos="zoom-in" data-aos-duration="300">
        <h3 className={width > 600 ? " ml-5" : " ml-3"}>
          {mem != ""
            ? "About " + capitalizeFirstLetter(mem) + " CGM48"
            : "Fetching Header"}
        </h3>
        <Breadcrumbs
                    ...
                    <div data-aos="fade-in" data-aos-duration="1500">
                      <div className="col-md mt-5 mb-5">
                          ...
                          {!item.graduated && (
                            <>
                              ...
                              <a
                                className="text-light"
                                href={
                                  "https://app.bnk48.com/members/cgm48/" +
                        ...
                        <a
                          ...
                          href={item.ref}
                          target="_blank">
                          Reference from CGM48 official Site
                        </a>
                        <br />
                        {v && birthday && (
                          <div className="row p-3 mt-3">
                            ...
                            <div className="ml-3 pt-2">
                              <Share
                                url={
                                  "https://cp-cgm48.pages.dev/member/" +
                                  item.name.toLowerCase()
                                }
                                options={{
                                  ...
                                  hashtags:
                                    item.name +
                                    "CGM48,fanspaceplatform,48groupthailand",
                                  size: "large",
                                }}
                                id="blessingshare"
                              />
                        ...
                        {item.graduated === true &&
                          item.graduatedDate != undefined && (
                            <div className="border border-info pb-3 mt-2 pt-3 rounded text-center">
                              <h6>
                                Member info of {item.name} CGM48 has been plan
                                to removed from CGM48 Fan Space in{" "}
        ...
        <div className="container mt-5">
          {newspop != null && newspop.length > 0 && (
            <h3 className="mb-4" data-aos="flip-up">
              Incoming events for {capitalizeFirstLetter(mem)} CGM48
            </h3>
          )}
          {newspop != null && (
            <>
              {newspop.length > 0 ? (
                ...
                <Card className="text-center" data-aos="zoom-in-up">
                  <CardContent>
                    {capitalizeFirstLetter(mem)} CGM48 doesn't have incoming
                    events right now.
                  </CardContent>
                </Card>
              )}
